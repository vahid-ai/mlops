...
spark = SparkSession.builder \
    ...
    .config("spark.sql.catalog.lakefs.uri", "http://localhost:8000/api/v1/repositories/kronodroid/refs/dev/iceberg") \
    .config("spark.sql.catalog.lakefs.credential", "AKIAJFUXKT62JAV6MTXQ") \
    .config("spark.sql.catalog.lakefs.token", "dA1fJlO1+QlERvWm7yvxczz9tL37qEz2TxGVX7bP") \
